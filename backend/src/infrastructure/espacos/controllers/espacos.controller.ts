...
export class EspacosController {
  ...
  async atualizarPredio(
    @Param("id") id: string,
    @Body() body: AtualizarPredio,
  ) {
  ...
  @ApiResponse({
    status: 400,
    description: "Não é possível remover prédio com salas vinculadas.",
  })
  ...
  @ApiResponse({
    status: 404,
    description: "O ID do prédio informado não existe.",
  })
