...
} from "../../../application/agenda/dto/agenda.dto";
...
@ApiResponse({
  status: 403,
  description: "Acesso negado, ação requer cargo maior.",
})
@Controller("agenda")
export class AgendaController {
  ...
  @Post("agendas")
  @Roles("organizador")
  @ApiOperation({ summary: "Criar agenda anual" })
  @ApiBody({ type: CriarAgenda })
  @ApiResponse({
    status: 201,
    description: "Agenda criada ou retornada com sucesso.",
  })
  async criarAgenda(@Body() body: CriarAgenda) {
    return this.agendaService.criarAgenda(body);
  }

  @Get("agendas")
  @Roles("organizador", "professor")
  @ApiOperation({ summary: "Listar agendas anuais" })
  async listarAgendas() {
  ...
  @Roles("organizador")
  @ApiOperation({
    summary: "Criar horários disponíveis recorrentes em um período",
  })
  @ApiBody({ type: CriarDisponibilidades })
  async criarDisponibilidades(@Body() body: CriarDisponibilidades) {
    return this.agendaService.criarDisponibilidades(body);
  }

  @Get("turmas")
  @Roles("organizador", "professor")
  @ApiOperation({ summary: "Listar turmas disponíveis para reserva" })
  async listarTurmas() {
    return this.agendaService.listarTurmas();
  }
  ...
  @ApiQuery({
    name: "espacoId",
    required: false,
    description: "Filtrar por Sala/Laboratório",
  })
  @ApiQuery({
    name: "turmaId",
    required: false,
